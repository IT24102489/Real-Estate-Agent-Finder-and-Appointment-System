...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow_box" id="navbar_sticky">
  <div class="container-xl">
    <a class="text-black p-0 navbar-brand fw-bold logo_position_rel" href="UserDashboard.jsp"> Estate <i class="fa fa-home col_blue me-1 logo_position_abs"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="col_red">Agent</span></a>
			...
			<div class="col-md-12">
				<div class="login_1m p-4 w-50 mx-auto bg-light">
					...
					<form action="${pageContext.request.contextPath}/register" method="post">
						...
						<h6 class="mb-3 fw-bold mt-4">Role</h6>
						...
						<h6 class="mt-3 center_sm"><button type="submit" class="button_2 d-block text-center w-100">Register</button></h6>
					</form>
					<p class="mt-3 mb-0 text-center">Already have an account? <a class="fw-bold col_blue" href="login.jsp">Login</a></p>
				</div>
			</div>
		</div>
	</div>
