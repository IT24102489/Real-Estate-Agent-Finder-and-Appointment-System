    ...
    <div class="col-md-12">
      <div class="login_1m p-4 w-50 mx-auto bg-light">
        ...
        <label class="form-check-label" for="customCheck1">Agree to our <a class="fw-bold" href="#">terms & conditions</a></label>
		  ...
		  <h6 class="mt-3 center_sm"><a class="button_2 d-block text-center" href="#">SIGN UP</a></h6>
		  <p class="mt-3 mb-0 text-center">Already have an account?  <a class="fw-bold col_blue" href="login.html"> Login</a></p>
		</div>
   </div>
  </div>
 </div>
