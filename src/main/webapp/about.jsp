		...
		<div class="container-xl">
			<div class="row center_o1 m-auto text-center">
				<div class="col-md-12">
					...
					<h6 class="text-white mb-0 mt-3"><a class="text-white" href="#">Home</a> <span class="mx-2 text-warning">/</span> About Us </h6>
				</div>
			</div>
		</div>
	</div>
...
<section id="about" class="p_3">
	<div class="container-xl">
		<div class="about_1 row">
			<div class="col-md-12">
				<h6 class="col_blue fw-bold">About Prop Estate</h6>
				<h1 class="font_50 mt-3">We connect building with <br> people</h1>
				<p class="mt-3">Real estate is one of the most profitable and stable investment options, offering opportunities for both short-term and long-term gains. Whether you're buying, selling, or renting properties, understanding market trends, location value, and legal processes is essential.</p>
				<p class="mb-0">Our website provides the latest property listings, expert advice, and investment tips to help you make informed decisions. From luxury villas to affordable apartments, we connect buyers and sellers seamlessly. Explore mortgage guides, market insights, and legal FAQs to navigate Sri Lanka is real estate market with confidence. Start your property journey with us today!</p>
			</div>
		</div>
