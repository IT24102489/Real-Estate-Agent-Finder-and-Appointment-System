      ...
      <div class="login_1m p-4 bg-light w-50 mx-auto">
	   <h2 class="text-center mb-3">Login </h2>
        ...
        <label class="form-check-label" for="customCheck1">Remember Me</label>
		  ...
		  <h6 class="mt-3 center_sm"><a class="button_2 d-block text-center" href="#">LOGIN</a></h6>
	 ...
	 <h6 class="col-md-12 col-6 mt-2 mb-0"><a class="text-light" href="#"><i class="fa fa-chevron-right me-1 font_12 text-warning"></i> Others</a></h6>
		   ...
		   <div class="col-md-3">
		    <div class="footer_1ri1">
			 ...
			 <div class="row footer_3ism">
		 <h6 class="col-md-12 col-6"><a class="text-light" href="#"><i class="fa fa-chevron-right me-1 font_12 text-warning"></i> Colombo</a></h6>
	 <h6 class="col-md-12 col-6 mt-2"><a class="text-light" href="#"><i class="fa fa-chevron-right me-1 font_12 text-warning"></i> Gampaha</a></h6>
	 <h6 class="col-md-12 col-6 mt-2"><a class="text-light" href="#"><i class="fa fa-chevron-right me-1 font_12 text-warning"></i> Matara</a></h6>
	 <h6 class="col-md-12 col-6 mt-2"><a class="text-light" href="#"><i class="fa fa-chevron-right me-1 font_12 text-warning"></i> Nuwara Eliya</a></h6>
	 <h6 class="col-md-12 col-6 mt-2"><a class="text-light" href="#"><i class="fa fa-chevron-right me-1 font_12 text-warning"></i> Galle</a></h6>
	 <h6 class="col-md-12 col-6 mt-2 mb-0"><a class="text-light" href="#"><i class="fa fa-chevron-right me-1 font_12 text-warning"></i>Hikkaduwa </a></h6>
	    </div>
			</div>
		   </div>
		   <div class="col-md-3">
    ...
    <div class="row footer_b1">
	 <div class="col-md-12">
	  <div class="footer_b1l text-center">
	    <p class="mb-0 text-light">© 2025 Real Estate Agent Finder And Appointment System. All Rights Reserved | Design by <a class="text-warning fw-bold" href="http://www.templateonweb.com">PGNO 266</a></p>
	  </div>
	 </div>
	</div>
 </div>
